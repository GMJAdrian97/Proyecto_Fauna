      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link active" href="../Cliente/CtrlIndex.php">Productos </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="../Cliente/CtrlMisCompras.php?accion=MisComprasss">Mis Compras   <i class="bi bi-bag-check"></i></a>
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="nosotros.php  "><i class="bi bi-cart"></i></a>
          </li>
